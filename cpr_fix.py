...
def _lgbm_cls_params(rnd: int):
    ...
    params = dict(
        ...
        num_leaves=63, max_depth=depth, feature_fraction=0.7, bagging_fraction=0.8, bagging_freq=1,
        min_data_in_leaf=700, min_gain_to_split=0.04, max_bin=255,
